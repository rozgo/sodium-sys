...
/// function provided by sodium_sys. The function can be called more than once,
/// but it should not be executed by multiple threads simultaneously. Add approp
/// riate locks around the function call if this scenario can happen in your
/// application.
///
/// After this function returns, all of the other functions provided by
/// sodium_sys will be thread-safe.
///
